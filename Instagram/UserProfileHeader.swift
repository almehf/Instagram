...
class UserProfileHeader: UICollectionViewCell {
    ...
    var user: Users? {
        didSet {
//            profileImageUrl
            guard let profileImageUrl = user?.userProfileImageUrl else { return }
    ...
    fileprivate func setupEditFollowButton() {
        ...
        if currentLoggedInUserId == userId {
            ...
            editProfileFollowButton.isHidden = false
    ...
    lazy var editProfile: UIButton = {
        ...
        button.layer.borderWidth = 1
        button.layer.cornerRadius = 3
        button.addTarget(self, action: #selector(editProfileSetup), for: .touchUpInside)
        return button
    }()
    
    @objc func editProfileSetup() {
    ...
    override init(frame: CGRect) {
        ...
        editProfile.anchor(top: postsLabel.bottomAnchor, left: postsLabel.leftAnchor, bottom: nil, right: followingLabel.rightAnchor, paddingTop: 2, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: 34)
